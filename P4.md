...
Suppose we work for Syracuse University ITS and we are in charge of managing a database of students. We have undergraduate students, graduate students, and prospective students. Every student has a netID and a tuition balance that they owe. Tuition at SU is $70,000 per year for undergrads, $40,000 per year for grads, and $0 per year for prospective students. It will be our responsibility to charge tuition to each student's account every year but SU has decided to adopt a new policy that rewards students that stay with the university. The policy works in the following manor, for every year a student stays with the university they get another $1,000 off of their tuition. So freshman save $1,000 off their first year tuition, sophomores save $2,000 off their second year tuition, etc. For the purpose of this exercise we can assume our database is just an arraylist of students.
